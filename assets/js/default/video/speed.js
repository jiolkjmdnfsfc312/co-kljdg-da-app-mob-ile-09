"object" == typeof navigator &&
  (function (e, t) {
    ...
    function C(e) {
      f.nodeList(e) || f.array(e)
        ? Array.from(e).forEach(C)
        : f.element(e) &&
          f.element(e.parentNode) &&
    ...
    function S(e, t) {
      return f.element(t) && f.element(t.parentNode) && f.element(e)
    ...
    function M(e, t) {
      ...
      return (
        e.split(",").forEach(function (e) {
          ...
          switch (t.charAt(0)) {
            case ".":
              f.object(i) && f.string(i.class) && (i.class += " ".concat(a)),
                (n.class = a);
              break;
            case "#":
              n.id = t.replace("#", "");
    ...
    var le = {
      ...
      createLabel: function (e) {
        var t =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          n = { pip: "PIP", airplay: "AirPlay" }[e] || ee(e, this.config);
        return A(
          "span",
          Object.assign({}, t, {
      ...
      createButton: function (e, t) {
        var n,
          ...
          c = !1;
        switch (
          ("type" in r || (r.type = "button"),
          "class" in r
            ? r.class.includes(this.config.classNames.control) ||
              (r.class += " ".concat(this.config.classNames.control))
        ...
        return (
          c
            ? (o.appendChild(
                le.createIcon.call(this, s, { class: "icon--pressed" })
              ),
              o.appendChild(
                le.createIcon.call(this, i, { class: "icon--not-pressed" })
              ),
              o.appendChild(
                le.createLabel.call(this, a, { class: "label--pressed" })
              ),
              o.appendChild(
                le.createLabel.call(this, n, { class: "label--not-pressed" })
              ))
            : (o.appendChild(le.createIcon.call(this, i)),
              o.appendChild(le.createLabel.call(this, n))),
          J(r, M(this.config.selectors.buttons[l], r)),
          T(o, r),
          "play" === l
            ? (f.array(this.elements.buttons[l]) ||
                (this.elements.buttons[l] = []),
              this.elements.buttons[l].push(o))
            : (this.elements.buttons[l] = o),
          o
        );
      },
      createRange: function (e, t) {
        ...
        return (
          (this.elements.inputs[e] = n), le.updateRangeFill.call(this, n), n
        );
      },
          ...
          function (i) {
            if (
              ...
              if (!s && [32, 39].includes(i.which))
                le.showMenuPanel.call(n, t, !0);
              else
                32 !== i.which &&
                  (40 === i.which || (s && 39 === i.which)
                    ? ((a = e.nextElementSibling),
                      f.element(a) || (a = e.parentNode.firstElementChild))
                    : ((a = e.previousElementSibling),
                      f.element(a) || (a = e.parentNode.lastElementChild)),
                  O.call(n, a, !0));
            }
          },
          !1
      ...
      createMenuItem: function (e) {
        ...
        (h.innerHTML = s),
          ...
          le.bindMenuItemShortcuts.call(this, d, a),
          i.appendChild(d);
      },
      formatTime: function () {
        var e =
                ...
                (n = this.currentTime),
                  ...
                  (a =
                    0 === n || 0 === i || Number.isNaN(n) || Number.isNaN(i)
                      ...
                      : ((n / i) * 100).toFixed(2)),
                  "timeupdate" === e.type &&
                    le.setRange.call(this, this.elements.inputs.seek, a);
                break;
              case "playing":
              case "progress":
                !(function (e, n) {
      ...
      timeUpdate: function (e) {
        var t =
          !f.element(this.elements.display.duration) && this.config.invertTime;
        le.updateTimeDisplay.call(
          this,
      ...
      durationUpdate: function () {
        if (
          ...
          !e &&
            ...
            le.updateSeekTooltip.call(this);
        }
      },
      ...
      updateSetting: function (e, t, n) {
        ...
        if ("captions" === e) a = this.currentTrack;
          ...
          if (
            ((a = f.empty(n) ? this[e] : n),
            f.empty(a) && (a = this.config[e].default),
            !f.empty(this.options[e]) && !this.options[e].includes(a))
          )
        ...
        if (
          (f.element(s) || (s = i && i.querySelector('[role="menu"]')),
          f.element(s))
        ) {
          this.elements.settings.buttons[e].querySelector(
            ".".concat(this.config.classNames.menu.value)
          ).innerHTML = le.getLabel.call(this, e, a);
      ...
      setQualityMenu: function (e) {
        ...
        if (f.element(this.elements.settings.panels.quality)) {
          ...
          var i =
            !f.empty(this.options.quality) && this.options.quality.length > 1;
          if (
            (le.toggleMenuButton.call(this, "quality", i),
            P(n),
            le.checkMenu.call(this),
            i)
          ) {
      ...
      setCaptionsMenu: function () {
        ...
        if (f.element(this.elements.settings.panels.captions)) {
          var t =
            ...
            i = Boolean(n.length);
          if (
            (le.toggleMenuButton.call(this, "captions", i),
            P(t),
            le.checkMenu.call(this),
            i)
          ) {
            var a = n.map(function (n, i) {
              return {
                ...
                badge:
                  n.language &&
                  le.createBadge.call(e, n.language.toUpperCase()),
                list: t,
                type: "language",
              };
            });
            a.unshift({
              ...
              a.forEach(le.createMenuItem.bind(this)),
              le.updateSetting.call(this, "captions", t);
          }
        }
      },
      setSpeedMenu: function (e) {
        ...
        if (f.element(this.elements.settings.panels.speed)) {
          ...
          f.array(e)
            ...
            /* Mengatur Kecepatn Video */
              (this.options.speed = [0.5, 0.75, 1]),
            (this.options.speed = this.options.speed.filter(function (e) {
              return t.config.speed.options.includes(e);
            }));
          var i = !f.empty(this.options.speed) && this.options.speed.length > 1;
          le.toggleMenuButton.call(this, "speed", i),
            P(n),
            le.checkMenu.call(this),
            i &&
      ...
      toggleMenu: function (e) {
        ...
        if (f.element(t) && f.element(n)) {
          ...
          n.setAttribute("aria-expanded", a),
            ...
            a && f.keyboardEvent(e)
              ? le.focusFirstMenuItem.call(this, null, !0)
              : a || i || O.call(this, n, f.keyboardEvent(e));
        }
      },
      ...
      create: function (e) {
        ...
        if (
          (this.config.controls.includes("restart") &&
            n.appendChild(le.createButton.call(this, "restart")),
          this.config.controls.includes("rewind") &&
            n.appendChild(le.createButton.call(this, "rewind")),
          this.config.controls.includes("play") &&
            n.appendChild(le.createButton.call(this, "play")),
          this.config.controls.includes("fast-forward") &&
            n.appendChild(le.createButton.call(this, "fast-forward")),
          this.config.controls.includes("progress"))
        ) {
          var i = A("div", M(this.config.selectors.progress));
          if (
            (i.appendChild(
              le.createRange.call(this, "seek", {
                id: "plyr-seek-".concat(e.id),
              })
            ),
            i.appendChild(le.createProgress.call(this, "buffer")),
            this.config.tooltips.seek)
          ) {
            var a = A(
              "span",
        ...
        if (
          (this.config.controls.includes("current-time") &&
            n.appendChild(le.createTime.call(this, "currentTime")),
          this.config.controls.includes("duration") &&
            n.appendChild(le.createTime.call(this, "duration")),
          ...
          if (
            (this.config.controls.includes("mute") &&
              s.appendChild(le.createButton.call(this, "mute")),
            this.config.controls.includes("volume"))
          ) {
        ...
        if (
          (this.config.controls.includes("captions") &&
            n.appendChild(le.createButton.call(this, "captions")),
          this.config.controls.includes("settings") &&
            !f.empty(this.config.settings))
        ) {
          var r = A("div", { class: "plyr__menu", hidden: "" });
          r.appendChild(
            le.createButton.call(this, "settings", {
              "aria-haspopup": !0,
          ...
          u.appendChild(d),
            ...
            this.config.settings.forEach(function (n) {
              ...
              le.bindMenuItemShortcuts.call(t, i, n),
                y(i, "click", function () {
              ...
              r.appendChild(A("span", { "aria-hidden": !0 }, ee(n, t.config))),
                r.appendChild(
                  A(
                    "span",
                    { class: t.config.classNames.hidden },
                    ee("menuBack", t.config)
                  )
                ),
                y(
                  o,
                  ...
                  function (e) {
                    37 === e.which &&
                      (e.preventDefault(),
                      e.stopPropagation(),
                      le.showMenuPanel.call(t, "home", !0));
                  },
                  !1
                ),
                y(r, "click", function () {
        ...
        return (
          this.config.controls.includes("pip") &&
            z.pip &&
            n.appendChild(le.createButton.call(this, "pip")),
          this.config.controls.includes("airplay") &&
            z.airplay &&
            n.appendChild(le.createButton.call(this, "airplay")),
          this.config.controls.includes("fullscreen") &&
            n.appendChild(le.createButton.call(this, "fullscreen")),
          this.config.controls.includes("play-large") &&
            this.elements.container.appendChild(
              le.createButton.call(this, "play-large")
            ),
          (this.elements.controls = n),
          this.isHTML5 &&
            le.setQualityMenu.call(this, W.getQualityOptions.call(this)),
          le.setSpeedMenu.call(this),
          n
        );
      },
      inject: function () {
        ...
        if (
          (s &&
            (f.string(this.config.controls)
              ? (n = r(n))
              : f.element(n) && (n.innerHTML = r(n.innerHTML))),
          f.string(this.config.selectors.controls.container) &&
            (o = document.querySelector(
              this.config.selectors.controls.container
            )),
          f.element(o) || (o = this.elements.container),
          o[f.element(n) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            n
          ),
          f.element(this.elements.controls) || le.findElements.call(this),
        ...
        setup: function () {
          if (this.supported.ui)
            if (
              ...
              if (
                (f.boolean(o) || (o = this.config.captions.active),
        ...
        update: function () {
          ...
          this.isHTML5 &&
            ...
            ((r && this.language !== a) || !t.includes(o)) &&
              (de.setLanguage.call(this, a), de.toggle.call(this, i && r)),
            L(
            ...
            if (a !== n) {
              if (
                ...
                return (
                  ...
                  void de.set.call(this, o.indexOf(r))
                );
              }
              this.elements.buttons.captions &&
                ...
                le.updateSetting.call(this, "captions"),
                k.call(
                  this,
                  this.media,
        ...
        getLabel: function (e) {
          ...
          return (
            ...
            f.track(t)
              ? f.empty(t.label)
                ? f.empty(t.language)
                  ? ee("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : ee("disabled", this.config)
          );
        },
    ...
    function ye() {
      if (this.enabled) {
        ...
        f.element(e) && (e.pressed = this.active),
          k.call(
            this.player,
            this.target,
      ...
      function t(n) {
        ...
        e(this, t),
          ...
          y.call(
            ...
            "dblclick",
            function (e) {
              (f.element(i.player.elements.controls) &&
              ...
              get: function () {
                ...
                return (
                  ["webkit", "moz", "ms"].some(function (t) {
                    return (
                      !(
                        !f.function(document["".concat(t, "ExitFullscreen")]) &&
                        !f.function(document["".concat(t, "CancelFullScreen")])
                      ) && ((e = t), !0)
                    );
                  }),
                  e
    ...
    var we = {
        ...
        build: function () {
          ...
          if ((this.listeners.media(), !this.supported.ui))
            return (
              ...
              void we.toggleNativeControls.call(this, !0)
            );
          f.element(this.elements.controls) ||
            (le.inject.call(this), this.listeners.controls()),
            we.toggleNativeControls.call(this),
            ...
            (this.loop = null),
            (this.quality = null),
            le.updateVolume.call(this),
            le.timeUpdate.call(this),
            we.checkPlaying.call(this),
            L(
              this.elements.container,
            ...
            we.setTitle.call(this),
            this.poster &&
              we.setPoster.call(this, this.poster, !1).catch(function () {}),
            this.config.duration && le.durationUpdate.call(this);
        },
        setTitle: function () {
        ...
        checkPlaying: function (e) {
          ...
          L(
            ...
            (f.event(e) && "timeupdate" === e.type) ||
              we.toggleControls.call(this);
        },
            ...
            },
            {
              ...
              value: function (e, t, n) {
                var i = this.player,
                  ...
                  s = !0;
                f.function(a) && (s = a.call(i, e)),
                  s && f.function(t) && t.call(i, e);
              },
            },
            {
              key: "bind",
                    ...
                    function (e) {
                      ...
                      [13, 32].includes(n) &&
                        (13 !== n
                          ? (e.preventDefault(),
                            e.stopPropagation(),
                            le.toggleMenu.call(t, e))
                          : le.focusFirstMenuItem.call(t, null, !0));
                    },
                    null,
                    !1
                  ),
                ...
                this.bind(
                  ...
                  this.bind(n.controls, "focusin focusout", function (n) {
                    var i = t.config,
                      ...
                      o = "focusin" === n.type;
                    if (
                      (L(a.controls, i.classNames.noTransition, o),
                      we.toggleControls.call(t, o),
                      o)
                    ) {
                      setTimeout(function () {
    ...
    var Se = {
      setup: function () {
        ...
        L(this.elements.wrapper, this.config.classNames.embed, !0),
          Se.setAspectRatio.call(this),
          f.object(window.Vimeo)
            ? Se.ready.call(this)
            : Ce(this.config.urls.vimeo.sdk)
                .then(function () {
                  Se.ready.call(e);
                })
                .catch(function (t) {
      ...
      ready: function () {
        ...
        l.appendChild(o),
          (t.media = S(l, t.media)),
          ne(Q(t.config.urls.vimeo.api, s), "json").then(function (e) {
            if (!f.empty(e)) {
              var n = new URL(e[0].thumbnail_large);
              (n.pathname = "".concat(n.pathname.split("_")[0], ".jpg")),
                we.setPoster.call(t, n.href).catch(function () {});
            }
          }),
        ...
        Object.defineProperty(t.media, "loop", {
          ...
          t.embed.on("loaded", function () {
            ...
            f.element(t.embed.element) && t.supported.ui) &&
      ...
      Le = {
        setup: function () {
          ...
          L(this.elements.wrapper, this.config.classNames.embed, !0),
            ...
            f.object(window.YT) && f.function(window.YT.Player)
              ? Le.ready.call(this)
              : (Ce(this.config.urls.youtube.sdk).catch(function (t) {
        ...
        getTitle: function (e) {
          ...
          if (f.function(this.embed.getVideoData)) {
            ...
            if (f.empty(n))
              return (this.config.title = n), void we.setTitle.call(this);
          }
          var i = this.config.keys.google;
          f.string(i) &&
            !f.empty(i) &&
            ne(Q(this.config.urls.youtube.api, e, i))
              .then(function (e) {
                f.object(e) &&
        ...
        return (
          n(t, [
              ...
              value: function () {
                ...
                this.enabled &&
                  (f.object(window.google) && f.object(window.google.ima)
                    ? this.ready()
                    : Ce(this.player.config.urls.googleIMA.sdk)
                        .then(function () {
                          e.ready();
                        })
                        .catch(function () {
              ...
              value: function () {
                ...
                this.countdownTimer = setInterval(function () {
                  var t = re(Math.max(e.manager.getRemainingTime(), 0)),
                    n = ""
                      .concat(ee("advertisement", e.player.config), " - ")
                      .concat(t);
            ...
            },
            {
              ...
              value: function (e, t) {
                return (
                  f.array(this.events[e]) || (this.events[e] = []),
              ...
              this.destroy.call(
                ...
                function () {
                  (t.options.quality = []),
                    C(t.media),
                    (t.media = null),
                    f.element(t.elements.container) &&
                  ...
                  Object.assign(t, {
                    ...
                    we.addStyleHook.call(t),
                    t.isHTML5 && _e.insertElements.call(t, "source", n),
                    (t.config.title = e.title),
                    xe.setup.call(t),
                    t.isHTML5 &&
                      ("tracks" in e &&
                        _e.insertElements.call(t, "track", e.tracks),
                      t.media.load()),
      ...
      je = (function () {
        function t(n, i) {
          ...
          if (
            ...
            (this.debug = new ge(this.config.debug)),
            ...
            if (this.media.plyr) this.debug.warn("Target already setup");
              ...
              if (z.check().api) {
                ...
                switch (o) {
                  case "div":
                    if (
                      ((r = this.media.querySelector("iframe")), f.element(r))
                    ) {
                      if (
                        ((l = ce(r.getAttribute("src"))),
                ...
                (this.supported = z.check(
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      (this.fullscreen = new be(this)),
                      this.config.ads.enabled && (this.ads = new Ie(this)),
          ...
          n(
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  this.currentTime =
                    this.currentTime - (f.number(e) ? e : this.config.seekTime);
                },
              },
              {
                key: "forward",
                ...
                value: function (e) {
                  ...
                  if (this.ready) {
                      ...
                      (document.body.style.overflow = ""),
                        ...
                        n
                          ? (Object.keys(t.elements).length &&
                              (C(t.elements.buttons.play),
                              C(t.elements.captions),
                              C(t.elements.controls),
                              C(t.elements.wrapper),
                          ...
                          : (function () {
                            ...
                            f.function(e) && e.call(t.elements.original),
                            (t.ready = !1),
                            setTimeout(function () {
                    ...
                    this.stop(),
                      this.isHTML5
                        ? (clearTimeout(this.timers.loading),
                          we.toggleNativeControls.call(this, !0),
                          i())
                        : this.isYouTube
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  f.string(t) && (t = Number(t)),
                    f.number(t) || (t = this.storage.get("volume")),
                    f.number(t) || (t = this.config.volume),
                    t > 1 && (t = 1),
                    t < 0 && (t = 0),
                    (this.config.volume = t),
                    (this.media.volume = t),
                    !f.empty(e) && this.muted && t > 0 && (this.muted = !1);
                },
                get: function () {
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  f.boolean(t) || (t = this.storage.get("muted")),
                    f.boolean(t) || (t = this.config.muted),
                    (this.config.muted = t),
                    (this.media.muted = t);
                },
                get: function () {
              ...
              },
              {
                ...
                set: function (e) {
                  var t = null;
                  f.number(e) && (t = e),
                    f.number(t) || (t = this.storage.get("speed")),
                    f.number(t) || (t = this.config.speed.selected),
                    t < 0.1 && (t = 0.1),
                    t > 2 && (t = 2),
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? we.setPoster.call(this, e, !1).catch(function () {})
                ...
                value: function (e) {
                  ...
                  return (
                    f.string(e)
                      ...
                      : f.nodeList(e)
                      ? (i = Array.from(e))
                      : f.array(e) && (i = e.filter(f.element)),
                    f.empty(i)
                      ? null
                      : i.map(function (e) {
                          return new t(e, n);
